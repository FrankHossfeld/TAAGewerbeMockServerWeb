  ...
  public void onEvent(ApplicationEvent applicationEvent) {
    switch (applicationEvent.getType()) {
      case INITIALIZATION_FINISHED:
        System.out.println("ConfigurationApplication {} was initialized." +
                           applicationEvent.getResourceConfig()
                                           .getApplicationName());
        break;
      case DESTROY_FINISHED:
        System.out.println("ConfigurationApplication {} was detroyed." +
                           applicationEvent.getResourceConfig()
                                           .getApplicationName());
        break;
      default:
      ...
      switch (requestEvent.getType()) {
        ...
        case RESOURCE_METHOD_FINISHED:
          ...
          final String resourceName = requestEvent.getUriInfo()
                                                  ...
                                                  .getHandlerClass()
                                                  .getName();
          System.out.println("ConfigurationApplication -> " + resourceName + ": Method '" + methodName + "' executed. Processing time: " + methodExecution + " ms");
          break;
        case ON_EXCEPTION:
          System.out.println("=====================================================================================================================================================");
          ...
          if (uriInfo != null) {
            if (uriInfo.getMatchedResourceMethod() != null) {
              ...
              final String exceptionResourceCause = requestEvent.getException()
                                                                .getCause()
                                                                .getMessage();
              System.out.println("ConfigurationApplication -> " + exceptionResourceName + ": Method '" + expeptionMethodName + "' fails! ==> " + exceptionResourceCause);
            }
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
          }
